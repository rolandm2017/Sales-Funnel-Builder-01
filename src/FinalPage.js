	...
	renderStateComponents() {
		...
		for (let i = 0; i < this.props.comp.length; i++) {
			...
			if (this.props.comp[i].type === "Header") {
				...
				// TODO: (1) take out all the input fields from ea. component
				// TODO: Refactor each component to act on props.pg1,2,3 (copy Header.js)
	...
	render() {
		return (
			<div>
				...
				<input
					placeholder={"Choose where to upload your copy..."}
				></input>
				<br />
